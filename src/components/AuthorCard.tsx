  ...
  return (
    <div className="author-card">
      <div className="social-links">
        <Link to="/forums" className="social-link" title="BOP forums">
          Forums
        </Link>
        ...
        <span className="social-separator">|</span>
        <Link to="/contracts" className="social-link" title="NFT and vault contracts — safety notes">
          Contracts
        </Link>
        <span className="social-separator">|</span>
      ...
      <div className="author-layout">
        ...
        <div className="author-info">
          <h3 className="author-name">BOP</h3>
          ...
          <div className="token-address-block">
            ...
            <div className="token-address-row">
              <div className="token-address-value">
                <span style={{ fontFamily: 'Times New Roman, serif' }}>$BOP:</span>{' '}
          ...
          <div className="author-bio">
            <p className="bio-paragraph">
              Wallet-native forum on Robinhood Chain: connect with MetaMask, register a username, and join the{' '}
              <Link to="/forums" className="text-blue-700 hover:text-blue-900 underline">
                forums
              </Link>
              . We never touch your keys. Your BOP balance is read on-chain and shown on your profile
            ...
            <p className="bio-paragraph final-bio">
              Dividends work like a locked treasure chest plus a membership card. At launch,{' '}
              <strong>20% of $BOP supply</strong> goes into a vault on Robinhood Chain that nobody can
              withdraw from — tokens only leave when NFT holders claim. Separately, you can swap $BOP
              for membership NFTs at a fixed rate of <strong>400,000 $BOP each</strong> (always
              reversible) — with <strong>500 NFTs</strong> max, that&apos;s up to{' '}
              <strong>200M $BOP</strong> that can ever sit in the swap (20% of supply). Hold an NFT and
              you can claim every <strong>3 hours</strong>: each payout is{' '}
              <strong>1% of whatever is still in the vault</strong>, scaled by how many NFTs you hold
              (e.g. 1 NFT ≈ 4,000 $BOP per claim at a full 200M vault; 10 NFTs ≈ 40,000).
              Early claims are larger; as the pool drips down, rewards shrink with it. Full desk, swap,
              and collection are on{' '}
