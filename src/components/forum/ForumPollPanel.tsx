...
export function ForumPollPanel({
  ...
  const { isRegistered } = useBopProfile();
    ...
    >
      {isGovernanceBoard ? (
        <p className="text-[0.72rem] text-gray-600 m-0 mb-2" style={{ fontFamily: 'Times New Roman, serif' }}>
          BOP Governance: creating polls and voting requires ≥ 0.25% of supply (2,500,000 BOP), or
          admin/moderator.
        </p>
      ) : null}
