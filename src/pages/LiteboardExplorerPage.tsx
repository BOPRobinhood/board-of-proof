  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-100/80 to-white text-gray-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-6">
          <h1 className="bop-pixel-title text-4xl tracking-tight text-slate-900 mb-1">
            Liteboard Explorer
          </h1>
          <p className="text-sm text-slate-600 max-w-2xl" style={{ fontFamily: 'Times New Roman, serif' }}>
            Browse community mini-forums for Robinhood Chain ERC-20 tokens. Search by contract address, sort by
            activity, and flip pages ({PAGE_SIZE} boards per page).
          </p>
        </div>

        <p className="text-xs text-gray-800 border border-gray-300 bg-gray-50 px-3 py-2 mb-6" style={{ fontFamily: 'Arial, sans-serif' }}>
          Deploy verifies the token on-chain via <strong>ROBINHOOD_RPC_URL</strong> (ERC-20).
        </p>
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 mb-6">
          <input
            ...
            placeholder="Token contract 0x… (3+ chars to filter)"
            value={q}
                    ...
                    <div className="rounded-xl border border-slate-200/90 bg-white shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                      ...
                      <div className="border-t border-slate-200 bg-slate-50/50 px-2 sm:px-4 py-3">
                        <div
                          ...
                          style={{ fontFamily: 'Arial, sans-serif' }}
                        >
                          <div className={statBox} title="USD market cap (when available)">
                          ...
                          <div className={statBox} title="Token price USD (when available)">
