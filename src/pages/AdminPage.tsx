    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-4xl mx-auto px-6 py-6">
        ...
        >
          ...
          MetaMask to sign once; the server then issues a short-lived session token so later saves and searches do not
        ...
        <section className="mb-10">
          ...
          <p className="text-sm text-gray-700 mb-3" style={{ fontFamily: 'Times New Roman, serif' }}>
            ...
            the configured BOP token. Same tx_sig cannot be recorded twice.
          </p>
