    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-5xl mx-auto px-4 py-5 sm:px-6 sm:py-6">
        ...
        <p className="text-sm text-gray-700 mb-4" style={{ fontFamily: 'Times New Roman, serif' }}>
          ...
          Robinhood Chain transaction hash (<code className="text-xs">0x…</code>).
        </p>
                    ...
                    rows.map((a) => {
                      ...
                      return (
                        <tr key={a.id} className="forum-table-row bg-white">
                          ...
                          <td className="p-2 border border-gray-400 text-xs">
                            {a.tx_sig ? (
                              explorerTxUrl(a.tx_sig) ? (
                                <a
                                  href={explorerTxUrl(a.tx_sig)}
                                  target="_blank"
                                ...
                                <span className="font-mono" title={a.tx_sig}>
                                  {shortSig(a.tx_sig)}
                                </span>
                              )
                            ) : (
