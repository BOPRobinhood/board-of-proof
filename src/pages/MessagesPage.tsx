...
const keyStorage = (wallet: string) => `bop_pm_secret_${wallet}`;
const pmSessionStorage = (wallet: string) => `bop_pm_session_${wallet}`;
            ...
            <div key={r.id} className="border border-gray-300 p-3 bg-white">
              ...
              <p className="text-xs text-gray-600 m-0">
                ...
                {r.tx_sig ? (
                  <>
                    {' · '}tx:{' '}
                    {explorerTxUrl(r.tx_sig) ? (
                      <a
                        href={explorerTxUrl(r.tx_sig)}
                        target="_blank"
