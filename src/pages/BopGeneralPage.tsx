...
const SECTION_DB = 'BOP GENERAL';
const SECTION_LABEL = 'BOP General';
const BOARD_BASE = '/forums/bop-general';

const BopGeneralPage = () => {
    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-5xl mx-auto px-4 py-5 sm:px-6 sm:py-6">
        ...
        <p className="text-sm text-gray-700 mb-4" style={{ fontFamily: 'Times New Roman, serif' }}>
          Community boards — start threads and replies when you&apos;re registered.
        </p>
        ...
        {isRegistered ? (
          <div className="mt-4 p-4 border border-gray-400 bg-gray-50">
            <p className="text-sm text-gray-800 m-0" style={{ fontFamily: 'Times New Roman, serif' }}>
              Open a board above, then use <strong>Sign &amp; create</strong> to start a thread (wallet
              signature).
            </p>
          </div>
        ) : null}
