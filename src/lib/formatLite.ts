/** Whole BOP tokens (UI units). Used for “% of supply” next to compact holdings in thread sidebar. */
...
/** Whole $BOP amount only; thousands grouped with spaces (e.g. 1 000 000), no decimals. */
