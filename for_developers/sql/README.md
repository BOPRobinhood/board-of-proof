...
All **hand-run** database setup and migrations for BOP live here. We use **numeric prefixes** so the intended order is obvious (`001_`, `002_`, …).
...
| [`007_forum_boards_threads.sql`](007_forum_boards_threads.sql) | `forum_boards`, `forum_threads`; seeds BOP OFFICIAL boards. |
...
| [`013_ligder_general_boards.sql`](013_ligder_general_boards.sql) | **BOP GENERAL** section: General Chat, Suggestions, Introductions (community boards). |
| [`014_ligder_technical_boards.sql`](014_ligder_technical_boards.sql) | **BOP TECHNICAL** section: Development & Technical Discussion. |
...
| 2026-03-26 | `014` — BOP Technical board (`BOP TECHNICAL`). |
| 2026-03-26 | `013` — BOP General boards (section `BOP GENERAL`). |
